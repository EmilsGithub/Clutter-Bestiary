...
public class ModItemGroups {
    public static final RegistryKey<ItemGroup> CLUTTER_BESTIARY = RegistryKey.of(RegistryKeys.ITEM_GROUP, Identifier.of(ClutterBestiary.MOD_ID, "clutterbestiary"));

    public static void register() {

        Registry.register(Registries.ITEM_GROUP, CLUTTER_BESTIARY, FabricItemGroup.builder()
                .displayName(Text.translatable("itemgroup.clutterbestiary.item_group"))
