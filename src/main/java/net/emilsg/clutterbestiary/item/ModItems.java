...
public class ModItems {
    ...
    public static final Item RAW_LEVITATING_ECHOFIN = registerItem("raw_levitating_echofin", new UseTimeItem(new Item.Settings().food(new FoodComponent.Builder().nutrition(3).saturationModifier(0.1f).alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.POISON, 1200, 0), 1.0F).build()), 10, 80));
    public static final Item COOKED_LEVITATING_ECHOFIN = registerItem("cooked_levitating_echofin", new UseTimeItem(new Item.Settings().food(new FoodComponent.Builder().nutrition(6).saturationModifier(0.2f).alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.POISON, 100, 1), 1.0F).build()), 10, 60));
    ...
    public static final Item COOKED_VENISON_RIBS = registerItem("cooked_venison_ribs", new Item(new Item.Settings().food(new FoodComponent.Builder().nutrition(10).saturationModifier(0.4f).build())));
    public static final Item KOI = registerItem("koi", new Item(new Item.Settings().food(new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).build())));

    public static final Item LEVITATING_ECHOFIN_BUCKET = registerItem("levitating_echofin_bucket", new EchofinBucketItem(new Item.Settings().recipeRemainder(Items.BUCKET).maxCount(1), EchofinVariant.LEVITATING));
    public static final Item CHORUS_ECHOFIN_BUCKET = registerItem("chorus_echofin_bucket", new EchofinBucketItem(new Item.Settings().recipeRemainder(Items.BUCKET).maxCount(1), EchofinVariant.CHORUS));
    ...
    public static final Item BUTTERFLY_ELYTRA_SMITHING_TEMPLATE_SHARDS = registerItem("butterfly_elytra_smithing_template_shards", new Item(new Item.Settings()));
    public static final Item BUTTERFLY_ELYTRA_SMITHING_TEMPLATE = registerItem("butterfly_elytra_smithing_template", new ButterflyElytraSmithingTemplateItem(new Item.Settings()));
    ...
    public static final Item BUTTERFLY_SPAWN_EGG = registerItem("butterfly_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.BUTTERFLY, 757231, 12, new Item.Settings()));
    public static final Item CHAMELEON_SPAWN_EGG = registerItem("chameleon_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.CHAMELEON, 1744148, 16228345, new Item.Settings()));
    public static final Item ECHOFIN_SPAWN_EGG = registerItem("echofin_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.ECHOFIN, 16511998, 4661575, new Item.Settings()));
    public static final Item MOSSBLOOM_SPAWN_EGG = registerItem("mossbloom_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.MOSSBLOOM, 16053485, 7377453, new Item.Settings()));
    public static final Item KIWI_BIRD_SPAWN_EGG = registerItem("kiwi_bird_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.KIWI_BIRD, 6243108, 6275609, new Item.Settings()));
    public static final Item EMPEROR_PENGUIN_SPAWN_EGG = registerItem("emperor_penguin_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.EMPEROR_PENGUIN, 1973800, 16777210, new Item.Settings()));
    public static final Item BEAVER_SPAWN_EGG = registerItem("beaver_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.BEAVER, 5916211, 3356222, new Item.Settings()));
    public static final Item CAPYBARA_SPAWN_EGG = registerItem("capybara_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.CAPYBARA, 2169626, 16651589, new Item.Settings()));
    public static final Item CRIMSON_NEWT_SPAWN_EGG = registerItem("crimson_newt_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.CRIMSON_NEWT, 15783361, 11280416, new Item.Settings()));
    public static final Item WARPED_NEWT_SPAWN_EGG = registerItem("warped_newt_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.WARPED_NEWT, 1153925, 4464945, new Item.Settings()));
    public static final Item EMBER_TORTOISE_SPAWN_EGG = registerItem("ember_tortoise_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.EMBER_TORTOISE, 6052956, 8924463, new Item.Settings()));
    public static final Item JELLYFISH_SPAWN_EGG = registerItem("jellyfish_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.JELLYFISH, 5487623, 8732643, new Item.Settings()));
    public static final Item MANTA_RAY_SPAWN_EGG = registerItem("manta_ray_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.MANTA_RAY, 12895428, 2566460, new Item.Settings()));
    public static final Item SEAHORSE_SPAWN_EGG = registerItem("seahorse_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.SEAHORSE, 14593895, 12351763, new Item.Settings()));
    public static final Item POTION_WASP_SPAWN_EGG = registerItem("potion_wasp_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.POTION_WASP, 867453, 2357421, new Item.Settings()));
    public static final Item DRAGONFLY_SPAWN_EGG = registerItem("dragonfly_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.DRAGONFLY, 2463756, 87652394, new Item.Settings()));
    public static final Item BOOPLET_SPAWN_EGG = registerItem("booplet_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.BOOPLET, 5641645, 4241312, new Item.Settings()));
    public static final Item KOI_SPAWN_EGG = registerItem("koi_spawn_egg", new BestiarySpawnEggItem(ModEntityTypes.KOI, 0x3E4549, 0xFF2632, new Item.Settings()));
