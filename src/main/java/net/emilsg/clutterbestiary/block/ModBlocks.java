...
public class ModBlocks {
    ...
    public static final Block BUTTERFLY_COCOON = registerBlockWithoutItem("butterfly_cocoon", new ButterflyCocoonBlock(AbstractBlock.Settings.copy(Blocks.MOSS_BLOCK).nonOpaque().breakInstantly().sounds(BlockSoundGroup.MOSS_BLOCK)));
