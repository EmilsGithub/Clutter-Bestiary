...
import net.emilsg.clutter_bestiary.entity.client.model.CapybaraModel;
...
public class CapybaraRenderer extends MobEntityRenderer<CapybaraEntity, CapybaraModel<CapybaraEntity>> {
    private static final Identifier TEXTURE = new Identifier(ClutterBestiary.MOD_ID, "textures/entity/capybara_box.png");
