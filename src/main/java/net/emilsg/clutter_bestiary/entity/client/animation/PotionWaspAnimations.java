...
public class PotionWaspAnimations {
        ...
        public static final Animation POTIONWASP_POTION_SAC_POP = Animation.Builder.create(1.0F)
                .addBoneAnimation("potionSac", new Transformation(Transformation.Targets.SCALE,
                        ...
                        new Keyframe(0.9167F, AnimationHelper.createScalingVector(2.25F, 2.25F, 2.25F), Transformation.Interpolations.LINEAR),
                        new Keyframe(0.9583F, AnimationHelper.createScalingVector(2.25F, 2.25F, 2.25F), Transformation.Interpolations.LINEAR),
                        new Keyframe(0.999F, AnimationHelper.createScalingVector(2.25F, 2.25F, 2.25F), Transformation.Interpolations.LINEAR),
