...
public class SeahorseRenderer extends MobEntityRenderer<SeahorseEntity, SeahorseModel<SeahorseEntity>> {
    public static final Identifier YELLOW_TEXTURE = new Identifier(ClutterBestiary.MOD_ID, "textures/entity/yellow_seahorse_box.png");
    public static final Identifier LIGHT_BLUE_TEXTURE = new Identifier(ClutterBestiary.MOD_ID, "textures/entity/light_blue_seahorse_box.png");
    public static final Identifier RED_TEXTURE = new Identifier(ClutterBestiary.MOD_ID, "textures/entity/red_seahorse_box.png");
    public static final Identifier PURPLE_TEXTURE = new Identifier(ClutterBestiary.MOD_ID, "textures/entity/purple_seahorse_box.png");
