...
public class EmperorPenguinRenderer extends MobEntityRenderer<EmperorPenguinEntity, BestiaryModel<EmperorPenguinEntity>> {
    public static final Identifier ADULT_TEXTURE = new Identifier(ClutterBestiary.MOD_ID, "textures/entity/adult_emperor_penguin_box.png");
    public static final Identifier BABY_TEXTURE = new Identifier(ClutterBestiary.MOD_ID, "textures/entity/baby_emperor_penguin_box.png");
