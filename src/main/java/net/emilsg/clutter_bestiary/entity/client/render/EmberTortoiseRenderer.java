...
public class EmberTortoiseRenderer extends MobEntityRenderer<EmberTortoiseEntity, EmberTortoiseModel<EmberTortoiseEntity>> {
    private static final Identifier TEXTURE = Identifier.of(ClutterBestiary.MOD_ID, "textures/entity/ember_tortoise/ember_tortoise.png");
    private static final Identifier FIRE_TEXTURE = Identifier.of(ClutterBestiary.MOD_ID, "textures/entity/ember_tortoise/ember_tortoise_fire.png");
