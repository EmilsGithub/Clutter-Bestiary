...
import net.emilsg.clutter_bestiary.entity.client.animation.MossbloomAnimations;
...
public class MossbloomModel<T extends MossbloomEntity> extends BestiaryModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData lh = head.addChild("lh", ModelPartBuilder.create().uv(32, 48).mirrored().cuboid(-4.0F, -13.0F, 0.0F, 16.0F, 16.0F, 0.0F, new Dilation(0.0F)).mirrored(false)
        ...
        ModelPartData rh = head.addChild("rh", ModelPartBuilder.create().uv(32, 32).cuboid(-12.0F, -13.0F, -0.01F, 16.0F, 16.0F, 0.0F, new Dilation(0.0F))
    ...
    public void setAngles(MossbloomEntity mossbloom, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (mossbloom.isVariantOf(MossbloomVariant.HORNED)) this.updateAnimation(mossbloom.shakingAnimationState, MossbloomAnimations.MOSSBLOOM_SHAKE_HEAD, ageInTicks, 1f);
