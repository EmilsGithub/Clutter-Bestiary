...
import net.emilsg.clutter_bestiary.entity.custom.goal.EchofinConditionalActiveTargetGoal;
import net.emilsg.clutter_bestiary.entity.custom.goal.EchofinWanderAroundGoal;
import net.emilsg.clutter_bestiary.entity.custom.parent.ParentAnimalEntity;
import net.emilsg.clutter_bestiary.entity.variants.EchofinVariant;
