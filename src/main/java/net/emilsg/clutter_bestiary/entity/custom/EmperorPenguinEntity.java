...
import net.emilsg.clutter_bestiary.entity.custom.goal.EmperorPenguinLayEggGoal;
import net.emilsg.clutter_bestiary.entity.custom.goal.EmperorPenguinMateGoal;
