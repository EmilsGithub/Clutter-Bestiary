...
import net.emilsg.clutter_bestiary.entity.custom.goal.KiwiBirdLayEggGoal;
import net.emilsg.clutter_bestiary.entity.custom.goal.KiwiBirdMateGoal;
import net.emilsg.clutter_bestiary.entity.custom.goal.KiwiBirdWanderAroundFarGoal;
