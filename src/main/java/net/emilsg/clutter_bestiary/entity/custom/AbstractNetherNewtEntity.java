...
public abstract class AbstractNetherNewtEntity extends ParentAnimalEntity implements Angerable {
    ...
    public AbstractNetherNewtEntity(EntityType<? extends ParentAnimalEntity> entityType, World world) {
