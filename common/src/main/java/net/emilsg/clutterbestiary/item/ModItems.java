...
public class ModItems {
    ...
    public static final RegistrySupplier<Item> CAPYBARA_SPAWN_EGG = registerItem("capybara_spawn_egg", () -> new ArchitecturySpawnEggItem(ModEntityTypes.CAPYBARA, 2169626, 16651589, new Item.Settings()));
