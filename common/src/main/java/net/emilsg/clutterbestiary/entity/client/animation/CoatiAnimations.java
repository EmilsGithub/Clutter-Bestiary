...
public class CoatiAnimations {
    ...
    public static final Animation COATI_IDLE = Animation.Builder.create(1.5F).looping()
            .addBoneAnimation("head", new Transformation(Transformation.Targets.TRANSLATE,
            ...
            .addBoneAnimation("main", new Transformation(Transformation.Targets.SCALE,
                    ...
                    new Keyframe(0.75F, AnimationHelper.createScalingVector(1.025F, 1.025F, 1.025F), Transformation.Interpolations.CUBIC),
                    new Keyframe(1.5F, AnimationHelper.createScalingVector(1.0F, 1.0F, 1.0F), Transformation.Interpolations.CUBIC)
            ))
            .build();

    public static final Animation COATI_LEFT_EAR_TWITCH = Animation.Builder.create(0.1667F)
            .addBoneAnimation("leftEar", new Transformation(Transformation.Targets.ROTATE,
                    new Keyframe(0.0F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.CUBIC),
                    new Keyframe(0.0833F, AnimationHelper.createRotationalVector(-14.1614F, -37.8095F, 22.3717F), Transformation.Interpolations.CUBIC),
                    new Keyframe(0.1667F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.CUBIC)
            ))
            .build();

    public static final Animation COATI_RIGHT_EAR_TWITCH = Animation.Builder.create(0.1667F)
