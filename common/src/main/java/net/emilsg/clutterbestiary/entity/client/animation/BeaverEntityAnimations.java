...
public class BeaverEntityAnimations {
        ...
        public static final Animation BEAVER_STRIP_ITEMS = Animation.Builder.create(8.0F)
                ...
                .addBoneAnimation("frontRightLeg", new Transformation(Transformation.Targets.ROTATE,
                        ...
                        new Keyframe(4.25F, AnimationHelper.createRotationalVector(-9.7197F, -3.4049F, -9.408F), Transformation.Interpolations.CUBIC),
                        new Keyframe(4.5F, AnimationHelper.createRotationalVector(-9.7197F, -3.4049F, -9.408F), Transformation.Interpolations.CUBIC),
