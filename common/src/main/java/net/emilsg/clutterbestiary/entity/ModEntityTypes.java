...
public class ModEntityTypes {
    ...
    public static final RegistrySupplier<EntityType<CrimsonNewtEntity>> CRIMSON_NEWT = registerEntityType("crimson_newt", () -> EntityType.Builder.create(CrimsonNewtEntity::new, SpawnGroup.CREATURE).dimensions(0.75f, 0.75f).eyeHeight(0.4F).makeFireImmune().build("crimson_newt"));
    public static final RegistrySupplier<EntityType<WarpedNewtEntity>> WARPED_NEWT = registerEntityType("warped_newt", () -> EntityType.Builder.create(WarpedNewtEntity::new, SpawnGroup.CREATURE).dimensions(0.75f, 0.75f).eyeHeight(0.4F).makeFireImmune().build("warped_newt"));
